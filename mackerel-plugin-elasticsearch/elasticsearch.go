...
var graphdef map[string](mp.Graphs) = map[string](mp.Graphs){
	...
	"elasticsearch.indices.memory_size": mp.Graphs{
		...
		Metrics: [](mp.Metrics){
			...
			mp.Metrics{Name: "id_cache_size", Label: "Id Cache", Stacked: true},
			mp.Metrics{Name: "percolate_size", Label: "Percolate", Stacked: true},
			mp.Metrics{Name: "query_cache_size", Label: "Query Cache", Stacked: true},
		},
	},
...
var metricPlace map[string][]string = map[string][]string{
	...
	"id_cache_size":               []string{"indices", "id_cache", "memory_size_in_bytes"},
	"percolate_size":              []string{"indices", "percolate", "memory_size_in_bytes"},
	"query_cache_size":            []string{"indices", "query_cache", "memory_size_in_bytes"},
